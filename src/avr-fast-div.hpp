...
/**
 * @file 
 * @brief This is an implementation artifact that allows control of inlining
 * via a preprocessor token. 
 * 
 * @note This file should not be included directly. Instead, include avr-fast-div.h. 
 */

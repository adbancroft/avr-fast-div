...
static void test_fast_div_8(void) {
  ...
  // u8/u8
  assert_fastdiv_range((uint8_t)0U,      (uint8_t)UINT8_MAX,   (uint8_t)0U,      (uint8_t)UINT8_MAX);
}
...
static void test_fast_div_16(void) {
  ...
  // u16/u16
  assert_fastdiv_range((uint16_t)0U, (uint16_t)UINT16_MAX, (uint16_t)0U, (uint16_t)UINT16_MAX);
  // i16/i8
  assert_fastdiv_range((int16_t)INT16_MIN, (int16_t)INT16_MAX, (int8_t)INT8_MIN, (int8_t)INT8_MAX);
  // u16/u8
  assert_fastdiv_range((uint16_t)0U, (uint16_t)UINT16_MAX, (uint8_t)0U, (uint8_t)UINT8_MAX);
}
